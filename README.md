...
### 9. CHANGES FROM V2.3 -> V2.4
# Version checking enhancement!.
Now Luin, also known has **Silex** checks for new updates for you. When you run **.\Luin_v2.4 file_name.sx**,
Luin checks for updates then runs your files.
# Luin v2.3 → v2.4
